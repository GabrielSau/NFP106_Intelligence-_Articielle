...
def astar_initialiser(depart, arrivee):
    ...
    """
    # TODO
    # - créer la priority queue
    # - initialiser g, parent
    # - insérer le départ avec f=g+h
    ...
    f = g[depart] + heuristique_manhattan(depart, arrivee)
...
def astar_faire_une_etape(grille, etat, arrivee, couts):
    ...
    """
    # TODO
    # 1) gérer le cas pq vide
    # 2) extraire le noeud de f minimal
    ...
    while private_queue:
        ...
        for rr, cc, _ in voisins_4(grille, *node):
            ...
            if voisin not in g or g_voisin < g[voisin]:
                g[voisin] = g_voisin
                parent[voisin] = node
                f_voisin = g_voisin + heuristique_manhattan(voisin, arrivee)
