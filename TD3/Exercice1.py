...
def astar_faire_une_etape(grille, etat, arrivee, couts):
    ...
    meilleur_h = heuristique_manhattan(courant, arrivee) 
    ...
    for rr, cc, _ in voisins_4(grille, *courant):
        ...
        h_voisin = heuristique_manhattan(voisin, arrivee)
    ...
    cout_voisin = cout_case(couts, meilleur_voisin)
    g[meilleur_voisin] = g[courant] + cout_voisin
